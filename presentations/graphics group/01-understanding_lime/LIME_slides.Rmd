...
knitr::include_graphics("./images/text_explanation.png")
```
...
knitr::include_graphics("./images/image_explanation.png")
```
...
knitr::include_graphics("./images/training_distributions.png")
```
...
knitr::include_graphics("./images/wolfhusky.png")
```
...
knitr::include_graphics("./images/wolf_husky_predictions.png")
```

## Wolf and Husky Lime Explanations

```{r, out.width = "750px", fig.align = "center"}
knitr::include_graphics("./images/wolf_husky_explanations.png")
```
...
```{r, out.width = "800px", fig.align = "center"}
knitr::include_graphics("./images/wolf_husky_predictions_explained.png")
```
