...
.center[<img src="./images/hamby.png" width=350>]
...
.center[<img src="./images/signatures.png" width=575>]
...
The random forest model fit to the training data in Hare, Hofmann, and Carriquiry can be found in the bulletr R package. It is called `rtrees`.

.pull-left[
```{r}
# Load the bulletr library
library(bulletr)
```
```{r}
...
.center[<img src="./images/app.png" width=1100>]
...
.center[<img src="./images/explain1.png" width=450>]
...
.center[<img src="./images/explain2.png" width=450>]
...
.center[<img src="./images/mse.png" width = 900>]

---

# Comparing $R^2$ Values

.center[<img src="./images/r2.png" width = 900>]

---

# Comparing Consistency Across Bins

.center[<img src="./images/firstfeature.png" width = 1100>]

---

# Comparing Consistency Across Bins

.center[<img src="./images/secondfeature.png" width = 1100>]

---

# Comparing Consistency Across Bins

.center[<img src="./images/thirdfeature.png" width = 1100>]

---

# Comparing Consistency Across Reps

.center[<img src="./images/reps1.png" width = 1100>]

---

# Comparing Consistency Across Reps

.center[<img src="./images/reps2.png" width = 1100>]

---

# Comparing Consistency Across Reps

.center[<img src="./images/reps3.png" width = 1100>]
