...
Slides for talks that I have given can be found below. They are ordered by date with the most recent talks at the top.
...
A presentation for the ISU graphics group on the current state of my research.
...
A talk given for the ISU graphics group with Katie Rey on our R package ggResidpanel.
...
A presentation for the ISU graphics group introducing LIME.
