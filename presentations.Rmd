...
Links to talks and posters I have presented can be found here. 

<br>

#### <font color="#2B547E"> Visual Diagnostics of a Model Explainer: Tools for the Assessment of LIME Explanations from Random Forests </font>
...
##### [Slides](https://goodekat.github.io/presentations/2019-jsm-lime_diagnostics/slides.pdf) 
##### [Poster](https://goodekat.github.io/presentations/2019-jsm-lime_diagnostics/poster.pdf)
...
#### <font color="#368BC1"> Using LIME to Interpret a Random Forest Model with an Application to Bullet Matching Data </font>
...
#### <font color="#2B547E"> An Application of LIME to a Random Forest Model </font>
...
#### <font color="#368BC1"> Interpreting Predictions from Black Box Models with LIME </font>
...
#### <font color="#2B547E"> Introducing ggResidpanel: An R Package for Easy Visualization of Residuals </font>
