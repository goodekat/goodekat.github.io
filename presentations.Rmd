...
Slides for [talks](#talks) that I have given and [posters](#posters) I have presented can be found here.

### Talks {#talks}

#### [An Application of LIME to a Random Forest Model](https://goodekat.github.io/presentations/graphics_group/03-applying_lime_to_random_forest/slides.html)
...
#### [Introducing ggResidpanel: An R Package for Easy Visualization of Residuals](https://goodekat.github.io/presentations/graphics_group/02-ggResidpanel/talk.html)
...
#### [Interpreting Predictions from Black Box Models with LIME](https://goodekat.github.io/presentations/graphics_group/01-understanding_lime/slides.html)
...
- [Introducing ggResidpanel: An R Package for Easy Visualization of Residuals](https://goodekat.github.io/presentations/kstate/ggResidpanel_poster/goode_rey_kstate.pptx)  
